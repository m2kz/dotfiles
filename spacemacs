...
before packages are loaded."
  (setq ycmd-server-command '("python3" "/home/michal/ycmd/ycmd"))
  (setq ycmd-force-semantic-completion t)
  (setq ycmd-extra-conf-whitelist '("/home/michal/*"))
