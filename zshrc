...
plugins=(branch gitfast autopep8 common-aliases compleat debian dircycle extract ssh-agent zsh-syntax-highlighting zsh-autosuggestions taskwarrior tmux web-search git sudo tig colorize emacs)
